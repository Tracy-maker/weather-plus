    ...
    <>
      ...
      >
        <div className="text-2xl text-white font-custom pt-5 px-5 sm:px-10 md:px-20 lg:px-32 xl:px-40">
          ...
          />
          <p className="text-lg sm:text-xl md:text-xl lg:text-xl xl:text-4xl text-white font-custom my-5 sm:my-10 mx-5 sm:mx-10 md:mx-20 lg:mx-32 xl:mx-40 font-bold tracking-wide leading-7 sm:leading-8 md:leading-9 lg:leading-10">
