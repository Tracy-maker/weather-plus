    ...
    <>
      ...
      >
        <div className=" pt-9 sm:px-16 md:px-20 lg:px-26 xl:px-30">
          ...
          <p className=" leading-loose text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl text-white font-custom my-5 sm:my-10 sm:mx-10 md:mx-20 lg:mx-32 xl:mx-40 font-bold tracking-wide">
